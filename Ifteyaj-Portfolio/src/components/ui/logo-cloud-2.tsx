...
export function LogoCloud({ className, ...props }: LogoCloudProps) {
  return (
    ...
    >
      ...
      <LogoCard
        className="relative border-b bg-secondary md:bg-background dark:bg-secondary/30 md:dark:bg-secondary/30"
        logo={{
      ...
      <LogoCard
        className="relative border-r border-b bg-secondary md:border-b-0 md:bg-background dark:bg-secondary/30 md:dark:bg-secondary/30"
        logo={{
      ...
      >
        <PlusIcon
          className="absolute -right-[12.5px] -bottom-[12.5px] z-10 size-6 md:hidden md:-left-[12.5px]"
          strokeWidth={1}
        />
      </LogoCard>

      <LogoCard
        className="border-b bg-background md:border-r md:border-b-0 md:bg-secondary dark:bg-background dark:md:bg-secondary/30"
        logo={{
